class TaskModel {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'status': status,
      'employeeStartTime': employeeStartTime?.toUtc().toIso8601String(),
...
class TaskStep {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'isOverdue': isOverdue,
      'employeeStartTime': employeeStartTime?.toUtc().toIso8601String(),
      'employeeReachTime': employeeReachTime?.toUtc().toIso8601String(),
      'employeeCompleteTime': employeeCompleteTime?.toUtc().toIso8601String(),
